...
print("love" == "love")  #true
print(1 == 1 or 2 != 1)  #true
print(True and 1 == 1)  #true
print(False and 0 != 0)  #false
print(True or 1 == 1)   #true
print("time" == "money")  #false
print(1 != 0 and 2 == 1)  #false
print("I Can't Believe It's Not Butter!" != "butter")  #true
print("one" == 1)  #false
print(not (True and False)) #true
print(not (1 == 1 and 0 != 1)) #false
print(not (10 == 1 or 1000 == 1000)) #false
print(not (1 != 10 or 3 == 4)) #true
print(not ("love" == "love" and "time" == "money")) #true
print(1 == 1 and (not ("one" == 1 or 1 == 0)))  #true
print("chunky" == "bacon" and (not (3 == 4 or 3 == 3)))  #false
print(3 == 3 and (not ("love" == "love" or "Python" == "Fun"))) #false